...
let xlsPath = process.argv[2];
let sourceTxtPath = process.argv[3];
...
;
function getHeadTemple(className, item) {
...
function getDesTemple(className, item) {
...
let index11 = 0;
function eachLien(filePath, importType) {
    let headerType = [];
    let headerName = [];
    let headerIsImport = [];
    let body = [];
